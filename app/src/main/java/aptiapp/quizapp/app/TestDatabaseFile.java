...
public class TestDatabaseFile extends SQLiteOpenHelper 
{
	SQLiteDatabase db;
	static int DBVERSION=2;
	static String DBNAME="aptidata";
	public TestDatabaseFile(Context context)
	{
	...
	public void onCreate(SQLiteDatabase arg0) {
		String query="Create table if not exists testimage(type text ,image text)";
		try
		{
			db.execSQL(query);
		}
	...
	public void onUpgrade(SQLiteDatabase arg0, int arg1, int arg2) {
		...
		db.execSQL("DROP TABLE IF EXISTS testimage");
		onCreate(db);
	...
	public ArrayList<String> TypesForIntro() 
	{
		...
		Cursor myCursor=db.rawQuery("select type from testimage", null);
		if(myCursor!=null)
		{
	...
	public ArrayList<String> ImagesForIntro() 
	{
		...
		Cursor myCursor1=db.rawQuery("select image from testimage", null);
		if(myCursor1!=null)
		{
